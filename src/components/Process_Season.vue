                    ...
                    <div>
                        <div>
                            ...
                            <el-cascader style="width: 400px"
                                         v-model="value"
                                         :options="catalog"
                                         :props="{ expandTrigger: 'hover' ,children: 'sub_cat',label: 'name',value:'code',disabled:false}"
                                         @change="handleChange"
                                         filterable
                                         placeholder="试试搜索：国有"
...
<script>
    import {getProcessSeasonCatalog, getProcessSeasonData} from "../api/api";
    ...
    export default {
        ...
        created() {
            this.getProcessSeasonData();
            this.getProcessSeasonCatalog();
        },
        watch: {
            row_value(val) {
        ...
        methods: {
            getProcessSeasonData() {
                this.loading = true;
                getProcessSeasonData(this.params).then((response) => {
