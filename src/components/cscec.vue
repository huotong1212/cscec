                            ...
                            <el-row>
                                <el-col :span="8">
                                    <div>
                                        ...
                                        <!--                                                :file-list="fileList1"-->
                                        <!--                                                :auto-upload="false">-->
                                        <!--                                            <el-button slot="trigger" size="small" type="primary">上传材料表</el-button>-->
                                        <!--                                            <el-button style="margin-left: 10px;" size="small" type="success"-->
                                        <!--                                                       @click="uploadFileMethod('材料表')">上传到服务器-->
                                        <!--                                            </el-button>-->
                                        <!--                                            &lt;!&ndash;                                    <div slot="tip" class="el-upload__tip">上传材料表</div>&ndash;&gt;-->
                                        <!--                                        </el-upload>-->
                                ...
                                <el-col :span="8">
                                    <div>
                                        ...
                                        <!--                                                :auto-upload="false">-->
                                        <!--                                            <el-button slot="trigger" size="small" type="primary">上传计算模型包</el-button>-->
                                        <!--                                            <el-button style="margin-left: 10px;" size="small" type="success"-->
                                        <!--                                                       @click="uploadTarFile('tar')">上传到服务器-->
                                        <!--                                            </el-button>-->
                                        <!--                                            &lt;!&ndash;                                        <div slot="tip" class="el-upload__tip">上传劳务表</div>&ndash;&gt;-->
                                        <!--                                        </el-upload>-->
                        ...
                        <div>
                            <el-table
                                ...
                                <el-table-column
                                        ...
                                        label="混凝土总量">
                                    <template scope="scope">
                                        <span>{{scope.row.total_concrete}}</span>
                                        <el-input class="input" size="mini" v-model="scope.row.concrete"
                                                  placeholder="请输入内容">
                                            <i slot="suffix" class="el-icon-edit"></i>
                                        </el-input>
                                    </template>
